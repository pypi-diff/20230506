# Comparing `tmp/pyBibX-2.9.7.tar.gz` & `tmp/pyBibX-2.9.8.tar.gz`
...
### Comparing `pyBibX-2.9.7/pyBibX/base/stws/Stopwords-Persian.txt` & `pyBibX-2.9.8/pyBibX/base/stws/Stopwords-Persian.txt`
