# Comparing `tmp/pibble-0.5.3.tar.gz` & `tmp/pibble-0.5.4.tar.gz`
...
### Comparing `pibble-0.5.3/pibble/api/client/base.py` & `pibble-0.5.4/pibble/api/client/base.py`
...
### Comparing `pibble-0.5.3/pibble/api/server/webservice/template/__init__.py` & `pibble-0.5.4/pibble/api/server/webservice/template/__init__.py`
...
### Comparing `pibble-0.5.3/pibble/database/util.py` & `pibble-0.5.4/pibble/database/util.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/cms/database/__init__.py` & `pibble-0.5.4/pibble/ext/cms/database/__init__.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/cms/database/interface.py` & `pibble-0.5.4/pibble/ext/cms/database/interface.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/cms/database/menu.py` & `pibble-0.5.4/pibble/ext/cms/database/menu.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/cms/database/view.py` & `pibble-0.5.4/pibble/ext/cms/database/view.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/cms/middleware.py` & `pibble-0.5.4/pibble/ext/cms/middleware.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/cms/server/base.py` & `pibble-0.5.4/pibble/ext/cms/server/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/cms/server/extension.py` & `pibble-0.5.4/pibble/ext/cms/server/extension.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/dam/database/files.py` & `pibble-0.5.4/pibble/ext/dam/database/files.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/rest/server/base.py` & `pibble-0.5.4/pibble/ext/rest/server/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/rest/server/user.py` & `pibble-0.5.4/pibble/ext/rest/server/user.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/session/database/session.py` & `pibble-0.5.4/pibble/ext/session/database/session.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/session/server/base.py` & `pibble-0.5.4/pibble/ext/session/server/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/user/client/base.py` & `pibble-0.5.4/pibble/ext/user/client/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/user/database/__init__.py` & `pibble-0.5.4/pibble/ext/user/database/__init__.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/user/database/authentication.py` & `pibble-0.5.4/pibble/ext/user/database/authentication.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/user/database/notification.py` & `pibble-0.5.4/pibble/ext/user/database/notification.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/user/database/permission.py` & `pibble-0.5.4/pibble/ext/user/database/permission.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/user/database/user.py` & `pibble-0.5.4/pibble/ext/user/database/user.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/ext/user/server/base.py` & `pibble-0.5.4/pibble/ext/user/server/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/hooks/aws.py` & `pibble-0.5.4/pibble/hooks/aws.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/media/thumbnail.py` & `pibble-0.5.4/pibble/media/thumbnail.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/resources/retriever.py` & `pibble-0.5.4/pibble/resources/retriever.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/scripts/importcheck.py` & `pibble-0.5.4/pibble/scripts/importcheck.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/scripts/templatefiles.py` & `pibble-0.5.4/pibble/scripts/templatefiles.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/setup.py` & `pibble-0.5.4/pibble/setup.py`
...
### Comparing `pibble-0.5.3/pibble/util/encryption.py` & `pibble-0.5.4/pibble/util/encryption.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/util/files.py` & `pibble-0.5.4/pibble/util/files.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/util/helpers.py` & `pibble-0.5.4/pibble/util/helpers.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/util/imaging.py` & `pibble-0.5.4/pibble/util/imaging.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/util/log.py` & `pibble-0.5.4/pibble/util/log.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/util/numeric.py` & `pibble-0.5.4/pibble/util/numeric.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/util/strings.py` & `pibble-0.5.4/pibble/util/strings.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble/web/scraper.py` & `pibble-0.5.4/pibble/web/scraper.py`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble.egg-info/PKG-INFO` & `pibble-0.5.4/pibble.egg-info/PKG-INFO`
...
### Comparing `pibble-0.5.3/pibble.egg-info/SOURCES.txt` & `pibble-0.5.4/pibble.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/pibble.egg-info/requires.txt` & `pibble-0.5.4/pibble.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `pibble-0.5.3/setup.py` & `pibble-0.5.4/setup.py`
