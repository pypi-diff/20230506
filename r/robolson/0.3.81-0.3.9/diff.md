# Comparing `tmp/robolson-0.3.81.tar.gz` & `tmp/robolson-0.3.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "robolson-0.3.81.tar", max compression
+gzip compressed data, was "robolson-0.3.9.tar", max compression
```

## Comparing `robolson-0.3.81.tar` & `robolson-0.3.9.tar`

### file list

```diff
@@ -1,50 +1,10 @@
--rw-r--r--   0        0        0      123 2022-07-23 00:18:58.660549 robolson-0.3.81/.autoenv
--rw-r--r--   0        0        0       56 2023-01-12 07:11:08.976913 robolson-0.3.81/.justfile
--rw-r--r--   0        0        0       24 2022-03-21 20:13:02.294495 robolson-0.3.81/__init__.py
--rw-r--r--   0        0        0       66 2022-03-21 23:26:56.141915 robolson-0.3.81/__main__.py
--rw-r--r--   0        0        0      829 2023-02-17 21:22:04.657577 robolson-0.3.81/anagram.py
--rw-r--r--   0        0        0    24615 2023-04-01 13:05:00.492511 robolson-0.3.81/clean.py
--rw-r--r--   0        0        0      103 2022-03-21 21:21:02.284735 robolson-0.3.81/config/.autoenv
--rw-r--r--   0        0        0     1006 2023-01-18 09:41:39.545792 robolson-0.3.81/config/clean.toml
--rw-r--r--   0        0        0   816591 2023-02-17 19:54:50.219010 robolson-0.3.81/data/word_list.txt
--rw-r--r--   0        0        0     5166 2023-01-21 00:44:10.045520 robolson-0.3.81/email.py
--rw-r--r--   0        0        0    10015 2023-03-23 10:24:04.360312 robolson-0.3.81/ffmpeg.py
--rw-r--r--   0        0        0     1043 2022-07-04 02:09:47.244686 robolson-0.3.81/help.py
--rw-r--r--   0        0        0    20235 2022-05-02 00:50:16.538685 robolson-0.3.81/hierarchy.py
--rw-r--r--   0        0        0        0 2022-05-21 03:18:54.857385 robolson-0.3.81/loggers/__init__.py
--rw-r--r--   0        0        0     1021 2022-07-14 03:10:34.224571 robolson-0.3.81/loggers/tick_logger.py
--rw-r--r--   0        0        0      228 2023-02-09 11:55:19.637586 robolson-0.3.81/New Text Document.reg
--rw-r--r--   0        0        0     1509 2023-05-06 17:13:02.774072 robolson-0.3.81/night.py
--rw-r--r--   0        0        0    22080 2023-01-24 18:58:55.889318 robolson-0.3.81/old_clean.py
--rw-r--r--   0        0        0        0 2022-05-21 03:18:36.761960 robolson-0.3.81/parser/__init__.py
--rw-r--r--   0        0        0     1119 2023-01-14 21:30:02.931167 robolson-0.3.81/parser/clean_parser.py
--rw-r--r--   0        0        0     1220 2022-07-08 10:11:15.790934 robolson-0.3.81/parser/email_parser.py
--rw-r--r--   0        0        0     1770 2022-04-08 02:11:14.941735 robolson-0.3.81/parser/ffmpeg_parser.py
--rw-r--r--   0        0        0     1509 2023-02-06 13:43:39.345746 robolson-0.3.81/parser/reddit_parser.py
--rw-r--r--   0        0        0      909 2022-07-04 01:50:11.624597 robolson-0.3.81/parser/tick_parser.py
--rw-r--r--   0        0        0   131013 2023-05-06 20:46:48.977806 robolson-0.3.81/poetry.lock
--rw-r--r--   0        0        0     1047 2023-05-06 20:48:55.383132 robolson-0.3.81/pyproject.toml
--rw-r--r--   0        0        0     8401 2023-02-06 13:44:14.394052 robolson-0.3.81/reddit_archive.py
--rw-r--r--   0        0        0     4153 2023-02-27 21:47:08.721554 robolson-0.3.81/robai.py
--rw-r--r--   0        0        0     5978 2023-02-08 17:22:46.858389 robolson-0.3.81/tick.py
--rw-r--r--   0        0        0        0 2022-04-07 19:21:12.560000 robolson-0.3.81/ticktick/__init__.py
--rw-r--r--   0        0        0    24751 2022-05-09 07:55:23.045790 robolson-0.3.81/ticktick/api.py
--rw-r--r--   0        0        0     1473 2022-05-02 00:50:17.516634 robolson-0.3.81/ticktick/cache.py
--rw-r--r--   0        0        0        0 2022-04-07 19:21:12.670000 robolson-0.3.81/ticktick/helpers/__init__.py
--rw-r--r--   0        0        0       68 2022-04-07 19:21:12.699905 robolson-0.3.81/ticktick/helpers/constants.py
--rw-r--r--   0        0        0     1184 2022-05-02 00:50:17.590600 robolson-0.3.81/ticktick/helpers/hex_color.py
--rw-r--r--   0        0        0     2787 2022-05-09 07:49:04.451389 robolson-0.3.81/ticktick/helpers/time_methods.py
--rw-r--r--   0        0        0     8805 2022-04-08 04:12:37.380147 robolson-0.3.81/ticktick/helpers/timezones.txt
--rw-r--r--   0        0        0        0 2022-04-07 19:21:12.804000 robolson-0.3.81/ticktick/managers/__init__.py
--rw-r--r--   0        0        0      444 2022-05-02 00:50:18.497442 robolson-0.3.81/ticktick/managers/check_logged_in.py
--rw-r--r--   0        0        0      408 2022-05-02 00:50:18.510446 robolson-0.3.81/ticktick/managers/focus.py
--rw-r--r--   0        0        0     4956 2022-05-02 00:50:18.524792 robolson-0.3.81/ticktick/managers/habits.py
--rw-r--r--   0        0        0      334 2022-05-02 00:50:18.547793 robolson-0.3.81/ticktick/managers/pomo.py
--rw-r--r--   0        0        0    43862 2022-06-11 04:09:26.134840 robolson-0.3.81/ticktick/managers/projects.py
--rw-r--r--   0        0        0      429 2022-05-02 00:50:18.617905 robolson-0.3.81/ticktick/managers/settings.py
--rw-r--r--   0        0        0    46804 2022-06-11 04:10:45.717520 robolson-0.3.81/ticktick/managers/tags.py
--rw-r--r--   0        0        0    54311 2022-06-11 04:08:26.998571 robolson-0.3.81/ticktick/managers/tasks.py
--rw-r--r--   0        0        0    13289 2022-05-09 07:54:06.826880 robolson-0.3.81/ticktick/oauth2.py
--rw-r--r--   0        0        0       24 2022-04-19 17:39:25.252880 robolson-0.3.81/tox.ini
--rw-r--r--   0        0        0     1319 2023-05-06 20:49:02.005649 robolson-0.3.81/setup.py
--rw-r--r--   0        0        0      851 2023-05-06 20:49:02.006633 robolson-0.3.81/PKG-INFO
...
### Comparing `robolson-0.3.81/hierarchy.py` & `robolson-0.3.9/rob/hierarchy.py`
...
### Comparing `robolson-0.3.81/robai.py` & `robolson-0.3.9/rob/robai.py`
