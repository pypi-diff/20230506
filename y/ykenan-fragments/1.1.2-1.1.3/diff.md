# Comparing `tmp/ykenan_fragments-1.1.2.tar.gz` & `tmp/ykenan_fragments-1.1.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ykenan_fragments-1.1.2.tar", last modified: Sat May  6 09:36:11 2023, max compression
+gzip compressed data, was "ykenan_fragments-1.1.3.tar", last modified: Sat May  6 12:04:18 2023, max compression
```

## Comparing `ykenan_fragments-1.1.2.tar` & `ykenan_fragments-1.1.3.tar`

### file list

```diff
@@ -1,18 +1,18 @@
-drwxrwxrwx   0        0        0        0 2023-05-06 09:36:11.309265 ykenan_fragments-1.1.2/
--rw-rw-rw-   0        0        0     1067 2023-03-12 01:42:12.000000 ykenan_fragments-1.1.2/LICENSE
--rw-rw-rw-   0        0        0       67 2023-03-17 07:56:10.000000 ykenan_fragments-1.1.2/MANIFEST.in
--rw-rw-rw-   0        0        0      964 2023-05-06 09:36:11.309265 ykenan_fragments-1.1.2/PKG-INFO
--rw-rw-rw-   0        0        0      424 2023-04-21 11:53:38.000000 ykenan_fragments-1.1.2/README.md
--rw-rw-rw-   0        0        0      773 2023-05-06 09:35:37.000000 ykenan_fragments-1.1.2/pyproject.toml
--rw-rw-rw-   0        0        0       51 2023-04-21 09:37:07.000000 ykenan_fragments-1.1.2/requirements.txt
--rw-rw-rw-   0        0        0       42 2023-05-06 09:36:11.309265 ykenan_fragments-1.1.2/setup.cfg
-drwxrwxrwx   0        0        0        0 2023-05-06 09:36:11.290250 ykenan_fragments-1.1.2/src/
-drwxrwxrwx   0        0        0        0 2023-05-06 09:36:11.294249 ykenan_fragments-1.1.2/src/ykenan_fragments/
--rw-rw-rw-   0        0        0    32575 2023-05-06 09:32:50.000000 ykenan_fragments-1.1.2/src/ykenan_fragments/__init__.py
--rw-rw-rw-   0        0        0     3185 2023-05-06 09:16:51.000000 ykenan_fragments-1.1.2/src/ykenan_fragments/genome_transformation.py
-drwxrwxrwx   0        0        0        0 2023-05-06 09:36:11.307249 ykenan_fragments-1.1.2/src/ykenan_fragments.egg-info/
--rw-rw-rw-   0        0        0      964 2023-05-06 09:36:11.000000 ykenan_fragments-1.1.2/src/ykenan_fragments.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      359 2023-05-06 09:36:11.000000 ykenan_fragments-1.1.2/src/ykenan_fragments.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-05-06 09:36:11.000000 ykenan_fragments-1.1.2/src/ykenan_fragments.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       51 2023-05-06 09:36:11.000000 ykenan_fragments-1.1.2/src/ykenan_fragments.egg-info/requires.txt
--rw-rw-rw-   0        0        0       17 2023-05-06 09:36:11.000000 ykenan_fragments-1.1.2/src/ykenan_fragments.egg-info/top_level.txt
...
### Comparing `ykenan_fragments-1.1.2/LICENSE` & `ykenan_fragments-1.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `ykenan_fragments-1.1.2/PKG-INFO` & `ykenan_fragments-1.1.3/src/ykenan_fragments.egg-info/PKG-INFO`
...
### Comparing `ykenan_fragments-1.1.2/pyproject.toml` & `ykenan_fragments-1.1.3/pyproject.toml`
...
### Comparing `ykenan_fragments-1.1.2/src/ykenan_fragments/__init__.py` & `ykenan_fragments-1.1.3/src/ykenan_fragments/__init__.py`
...
### Comparing `ykenan_fragments-1.1.2/src/ykenan_fragments/genome_transformation.py` & `ykenan_fragments-1.1.3/src/ykenan_fragments/genome_transformation.py`

 * *Files identical despite different names*

### Comparing `ykenan_fragments-1.1.2/src/ykenan_fragments.egg-info/PKG-INFO` & `ykenan_fragments-1.1.3/PKG-INFO`
