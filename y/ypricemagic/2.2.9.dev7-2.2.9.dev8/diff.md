# Comparing `tmp/ypricemagic-2.2.9.dev7.tar.gz` & `tmp/ypricemagic-2.2.9.dev8.tar.gz`
...
### Comparing `ypricemagic-2.2.9.dev7/tests/classes/test_singleton.py` & `ypricemagic-2.2.9.dev8/tests/classes/test_singleton.py`
