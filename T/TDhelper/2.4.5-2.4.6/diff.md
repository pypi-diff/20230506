# Comparing `tmp/TDhelper-2.4.5.tar.gz` & `tmp/TDhelper-2.4.6.tar.gz`
...
### Comparing `TDhelper-2.4.5/LICENSE` & `TDhelper-2.4.6/LICENSE`
...
### Comparing `TDhelper-2.4.5/TDhelper/cache/webCache/interface.py` & `TDhelper-2.4.6/TDhelper/cache/webCache/interface.py`
...
### Comparing `TDhelper-2.4.5/TDhelper/document/excel/model.py` & `TDhelper-2.4.6/TDhelper/document/excel/model.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/document/file.py` & `TDhelper-2.4.6/TDhelper/document/file.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/document/ini/meta.py` & `TDhelper-2.4.6/TDhelper/document/ini/meta.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/__init__.py` & `TDhelper-2.4.6/TDhelper/generic/__init__.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/classDocCfg.py` & `TDhelper-2.4.6/TDhelper/generic/classDocCfg.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/crypto/MD5.py` & `TDhelper-2.4.6/TDhelper/generic/crypto/MD5.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/dictHelper.py` & `TDhelper-2.4.6/TDhelper/generic/dictHelper.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/dynamic/base/Meta.py` & `TDhelper-2.4.6/TDhelper/generic/dynamic/base/Meta.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/dynamic/test.py` & `TDhelper-2.4.6/TDhelper/generic/dynamic/test.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/findAttribute.py` & `TDhelper-2.4.6/TDhelper/generic/findAttribute.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/recursion.py` & `TDhelper-2.4.6/TDhelper/generic/recursion.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/requier.py` & `TDhelper-2.4.6/TDhelper/generic/requier.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/standard_result.py` & `TDhelper-2.4.6/TDhelper/generic/standard_result.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/threadPools.py` & `TDhelper-2.4.6/TDhelper/generic/threadPools.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/generic/transformationType.py` & `TDhelper-2.4.6/TDhelper/generic/transformationType.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/http/REST_HTTP.py` & `TDhelper-2.4.6/TDhelper/network/http/REST_HTTP.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/http/RPC.py` & `TDhelper-2.4.6/TDhelper/network/http/RPC.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/http/RPC1.py` & `TDhelper-2.4.6/TDhelper/network/http/RPC1.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/http/http_helper.py` & `TDhelper-2.4.6/TDhelper/network/http/http_helper.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/http/http_postdataformat.py` & `TDhelper-2.4.6/TDhelper/network/http/http_postdataformat.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/http/m3u8.py` & `TDhelper-2.4.6/TDhelper/network/http/m3u8.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/http/m3u8_backup.py` & `TDhelper-2.4.6/TDhelper/network/http/m3u8_backup.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/rpc/Client/rpc.py` & `TDhelper-2.4.6/TDhelper/network/rpc/Client/rpc.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/rpc/Client/service.py` & `TDhelper-2.4.6/TDhelper/network/rpc/Client/service.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/rpc/Core/Meta.py` & `TDhelper-2.4.6/TDhelper/network/rpc/Core/Meta.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/rpc/Core/struct.py` & `TDhelper-2.4.6/TDhelper/network/rpc/Core/struct.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/rpc/Generic/Host.py` & `TDhelper-2.4.6/TDhelper/network/rpc/Generic/Host.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/rpc/Server/obsolete_Service.py` & `TDhelper-2.4.6/TDhelper/network/rpc/Server/obsolete_Service.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/rpc/Server/server.py` & `TDhelper-2.4.6/TDhelper/network/rpc/Server/server.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/rpc/Struct/Result.py` & `TDhelper-2.4.6/TDhelper/network/rpc/Struct/Result.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/socket/__init__.py` & `TDhelper-2.4.6/TDhelper/network/socket/__init__.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/socket/cache/queue.py` & `TDhelper-2.4.6/TDhelper/network/socket/cache/queue.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/socket/client.py` & `TDhelper-2.4.6/TDhelper/network/socket/client.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/socket/model/SOCKET_MODELS.py` & `TDhelper-2.4.6/TDhelper/network/socket/model/SOCKET_MODELS.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/socket/protocol/base.py` & `TDhelper-2.4.6/TDhelper/network/socket/protocol/base.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/socket/server.py` & `TDhelper-2.4.6/TDhelper/network/socket/server.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/websocket/protocol.py` & `TDhelper-2.4.6/TDhelper/network/websocket/protocol.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/network/websocket/server.py` & `TDhelper-2.4.6/TDhelper/network/websocket/server.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/reflect.py` & `TDhelper-2.4.6/TDhelper/reflect.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/control/D_33890.py` & `TDhelper-2.4.6/TDhelper/robot/control/D_33890.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/control/device.py` & `TDhelper-2.4.6/TDhelper/robot/control/device.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/people/__init__.py` & `TDhelper-2.4.6/TDhelper/robot/people/__init__.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/people/leg.py` & `TDhelper-2.4.6/TDhelper/robot/people/leg.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/people/scripts/runScript.py` & `TDhelper-2.4.6/TDhelper/robot/people/scripts/runScript.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/people/scripts/script.py` & `TDhelper-2.4.6/TDhelper/robot/people/scripts/script.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/struct/ankle.py` & `TDhelper-2.4.6/TDhelper/robot/struct/ankle.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/struct/base.py` & `TDhelper-2.4.6/TDhelper/robot/struct/base.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/struct/hip.py` & `TDhelper-2.4.6/TDhelper/robot/struct/hip.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/struct/knee.py` & `TDhelper-2.4.6/TDhelper/robot/struct/knee.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/robot/struct/toe.py` & `TDhelper-2.4.6/TDhelper/robot/struct/toe.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/shellScripts/saasHelper.py` & `TDhelper-2.4.6/TDhelper/shellScripts/saasHelper.py`
...
### Comparing `TDhelper-2.4.5/TDhelper/simulate/json.py` & `TDhelper-2.4.6/TDhelper/simulate/json.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/structs/dir.py` & `TDhelper-2.4.6/TDhelper/structs/dir.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/web/permission.py` & `TDhelper-2.4.6/TDhelper/web/permission.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper/web/permissionHelper.py` & `TDhelper-2.4.6/TDhelper/web/permissionHelper.py`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper.egg-info/PKG-INFO` & `TDhelper-2.4.6/TDhelper.egg-info/PKG-INFO`
...
### Comparing `TDhelper-2.4.5/TDhelper.egg-info/SOURCES.txt` & `TDhelper-2.4.6/TDhelper.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/TDhelper.egg-info/requires.txt` & `TDhelper-2.4.6/TDhelper.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `TDhelper-2.4.5/setup.py` & `TDhelper-2.4.6/setup.py`
