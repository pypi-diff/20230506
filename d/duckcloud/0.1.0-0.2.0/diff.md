# Comparing `tmp/duckcloud-0.1.0.tar.gz` & `tmp/duckcloud-0.2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "duckcloud-0.1.0.tar", max compression
+gzip compressed data, was "duckcloud-0.2.0.tar", max compression
```

## Comparing `duckcloud-0.1.0.tar` & `duckcloud-0.2.0.tar`

### file list

```diff
@@ -1,6 +1,6 @@
--rw-r--r--   0        0        0     1526 2023-05-05 19:40:56.200714 duckcloud-0.1.0/duckcloud/__init__.py
--rw-r--r--   0        0        0      462 2023-05-05 19:42:31.987823 duckcloud-0.1.0/duckcloud/Session.py
--rw-r--r--   0        0        0     1922 2023-05-05 20:42:51.440384 duckcloud-0.1.0/duckcloud/VM.py
--rw-r--r--   0        0        0      429 2023-05-05 20:19:28.705677 duckcloud-0.1.0/pyproject.toml
--rw-r--r--   0        0        0      118 2023-05-05 16:26:06.322101 duckcloud-0.1.0/README.md
--rw-r--r--   0        0        0      769 1970-01-01 00:00:00.000000 duckcloud-0.1.0/PKG-INFO
...
### Comparing `duckcloud-0.1.0/duckcloud/__init__.py` & `duckcloud-0.2.0/duckcloud/__init__.py`

 * *Files identical despite different names*

### Comparing `duckcloud-0.1.0/duckcloud/VM.py` & `duckcloud-0.2.0/duckcloud/VM.py`
...
### Comparing `duckcloud-0.1.0/PKG-INFO` & `duckcloud-0.2.0/PKG-INFO`
